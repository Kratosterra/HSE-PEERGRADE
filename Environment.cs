...
namespace Peergrade001
{
                      ...
                      //из-за большого колличества текстовой информации.
    {
        ...
        // 0)Запрос на нажате клавиши, чтобы продолжить
        ...
        // 4)"Попробуйте снова!" после не слишком удачной партии
        {
            ...
            {
                case "stop_button":
                    Environment.ConsoleText("stop"); //Выводим запрос на нажатие клавиши, создаём искуственную паузу.
                    Console.ReadKey();
            ...
            switch (interfaceType)
            {
                ...
                case "guess_error_1":
                    ...
                    Console.WriteLine("Догадка представлена в неправильном формате!\n" +
                        ...
                        "Ориентируетесь на стрелочки над полем ввода догадки, они наглядно показывают колличество требуемых цифр!\n" +
                        "Пожалуйста, повторите ввод!");
                    Console.ResetColor();
                    break;
                case "guess_error_2":
        ...
        //Метод создающий стрелочки над полем ввода, чтобы пользователь видел, сколько еще ему символов необходимо ввести.
        {
            string helpUser = "";
