...
namespace Peergrade001
{
    ...
    {
        static void Main() //Основной класс, тут происходит вызов омновного метода игры
        {
        ...
        //numDigits - переменная для настройки колличества загадываемых цифр в числе.
        //numGame - переменная для настройки колличества загадываемых цифр в числе.
        //exitKey - переменная для хранения информации о клавише выхода
        {
            do //В конце игры пользователь имеет парво нажать Escape, чтобы выйти из игры или любую другую клавишу, чтобы начать игру заново.
            {
                ...
                Environment.Interface("stop_button"); //Выводим запрос на нажатие клавиши, создаём искуственную паузу.
                ...
                System.Threading.Thread.Sleep(1200); //Создаём эффект сюрпириза, задержку в одну секунду!
